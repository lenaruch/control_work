...
1. Использование команды cat в Linux
   ...
   > Переименовать получившийся файл в `Human Friends`.
    ...
    Videos 
    ```
    Результат: [Скриншот комманд](/img/1-2.png), [История комманд](/commands.md)
2. Работа с директориями в Linux
    >Создать новую директорию и переместить туда файл `Human Friends`.

    Результат: [История комманд](/commands.md)
...
3. Работа с MySQL в Linux. 
   ...
   **“Установить MySQL на вашу вычислительную машину ”</p>**
    ...
    Результат: [Скриншот комманд](/img/3.png), [История комманд](/commands.md)

4. Управление deb-пакетами
    > Установить и затем удалить deb-пакет, используя команду `dpkg`.

    Результат: [Скриншот комманд](/img/4.png), [История комманд](/commands.md)

5. [История комманд](/commands.md) в терминале Ubuntu
